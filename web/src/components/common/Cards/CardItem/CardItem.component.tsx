...
export const CardItem: FC<IPassingProps> = ({ children }) => (
  <article className="w-full mx-auto  mt-5 sm:mt-2 sm:px-5 sm:py-3">
    <div className="w-full h-90 sm:h-80 lg:h-96 flex bg-green-50 flex-col justify-center items-center sm:flex-row  sm:justify-between sm:p-2 sm:px-2 border-gray-500 border-2 rounded-lg shadow-lg antialiased">
